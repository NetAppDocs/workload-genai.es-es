...
Con la API de Workload Factory, ahora puede agregar una fuente de datos desde un recurso compartido NFSv3, NFSv4 o SMB genérico.  Cuando agrega una fuente de datos desde un recurso compartido NFS o SMB, el volumen de la base de conocimiento permanece en un volumen de Amazon FSx for NetApp ONTAP .  La interfaz de usuario web de Workload Factory admitirá esta función en una versión futura.

link:https://console.workloads.netapp.com/api-doc["Utilice la API de Workload Factory"^]
