...
. En el icono AI Workloads, seleccione *Create Chatbot*.
...
+
Si activa los arrancadores de conversación, el modo automático está seleccionado de forma predeterminada. El modo manual solo se puede activar después de agregar fuentes de datos a su base de conocimientos. link:manage-knowledgebase.html["Aprenda a modificar la configuración de la base de conocimientos"].
