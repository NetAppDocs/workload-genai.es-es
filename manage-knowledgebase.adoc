...
Si ya no necesita una base de conocimientos, puede eliminarla. Al eliminar una base de conocimientos, se elimina de Workload Factory y el volumen que contiene la base de conocimientos se elimina. Cualquier aplicación o chatbots que estén utilizando la base de conocimientos dejará de funcionar. La supresión de una base de conocimientos no es reversible.
...
.Resultado
La base de conocimientos se elimina de Workload Factory y el volumen asociado se elimina.
